...
export const _greet = (name: string) => `	
Добрый день, ${name}!
...
export const _feedback = () => `Спасибо за обратную связь. HR менеджер свяжется с Вами в ближайшее время. 
			Телеграм для связи @ValeriBondareva`
export const feedback = () => `Спасибо за обратную связь. 
